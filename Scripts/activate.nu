...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Desktop\voting d app\JARVIS_AI\pythonProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Desktop\voting d app\JARVIS_AI\pythonProject\venv\Scripts\deactivate.nu'
